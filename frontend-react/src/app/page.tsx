      ...
      <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="card max-w-xl mx-auto text-center">
            ...
            {error && (
              <div className="mb-6 p-4 bg-red-900/50 border-l-4 border-red-500 text-red-200">
                <p>{error}</p>
              </div>
            )}
            ...
            <div className="flex justify-center">
              {isSearching ? (
                <div className="text-center">
                  ...
                  <p className="text-lg text-gray-300 mb-4">Ищем оппонента для вас...</p>
                  <button
                    onClick={cancelSearch}
                    disabled={loading}
                    className="bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-6 rounded-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
                  >
                    Отменить поиск
                  </button>
                </div>
                ...
                <button
                  onClick={startSearch}
                  disabled={loading}
                  className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg text-xl transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                >
                  {loading ? (
            ...
            <div className="mt-12 border-t border-gray-700 pt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                <div className="p-4 bg-gray-900/50 rounded-md">
                  <div className="text-blue-400 font-bold mb-2">1. Поиск</div>
                  <p className="text-sm text-gray-300">Нажмите кнопку поиска и система найдет для вас оппонента близкого по рейтингу.</p>
                </div>
                <div className="p-4 bg-gray-900/50 rounded-md">
                  <div className="text-blue-400 font-bold mb-2">2. Вопросы </div>
                  <p className="text-sm text-gray-300">Ответьте на 5 вопросов по программированию. На каждый вопрос дается 15 секунд.</p>
                </div>
                <div className="p-4 bg-gray-900/50 rounded-md">
                  <div className="text-blue-400 font-bold mb-2">3. Результаты</div>
                  <p className="text-sm text-gray-300">Побеждает участник с наибольшим количеством правильных ответов. Повышайте свой рейтинг!</p>
                </div>
              </div>
            </div>
          </div>
